...
namespace OpenNos.Core.Networking.Communication.Scs.Communication.Protocols.BinarySerialization
{
    ...
    /// </para>
    /// <para>A Message format: [Message Length (4 bytes)][Serialized Message Content]</para>
    /// <para>
    ...
    public class BinarySerializationProtocol : IScsWireProtocol, IDisposable
    {
        ...
        /// </summary>
        private const int MaxMessageLength = 128 * 1024 * 1024; // 128 Megabytes. shouldnt we use 4096 bytes instead?
