...
namespace OpenNos.GameObject
{
    public class BattleEntity
    {
        ...
        public BattleEntity(Character character, Skill skill = null)
        {
        ...
        public BattleEntity(Mate mate)
        {
            ...
            DamageMinimum = (mate.WeaponInstance?.BaseMinDamage ?? 0) + mate.DamageMinimum;
            DamageMaximum = (mate.WeaponInstance?.BaseMaxDamage ?? 0) + mate.DamageMaximum;
            WeaponDamageMinimum = (mate.WeaponInstance?.BaseMinDamage ?? DamageMinimum);
            WeaponDamageMaximum = (mate.WeaponInstance?.BaseMaxDamage ?? DamageMaximum);
            Hitrate = mate.Concentrate + (mate.WeaponInstance?.BaseHitRate ?? 0);
            ...
            MeleeDefense = (mate.ArmorInstance?.BaseCloseDefence ?? 0) + mate.MeleeDefense + mate.Monster.CloseDefence;
            RangeDefense = (mate.ArmorInstance?.BaseDistanceDefence ?? 0) + mate.RangeDefense + mate.Monster.DistanceDefence;
            MagicalDefense = (mate.ArmorInstance?.BaseMagicDefence ?? 0) + mate.MagicalDefense + mate.Monster.MagicDefence;
            MeleeDefenseDodge = (mate.ArmorInstance?.BaseDefenceDodge ?? 0) + mate.MeleeDefenseDodge + mate.Monster.DefenceDodge;
            RangeDefenseDodge = (mate.ArmorInstance?.BaseDistanceDefenceDodge ?? 0) + mate.RangeDefenseDodge + mate.Monster.DistanceDefenceDodge;

            ArmorMeleeDefense = mate.ArmorInstance?.BaseCloseDefence ?? MeleeDefense;
            ArmorRangeDefense = mate.ArmorInstance?.BaseDistanceDefence ?? RangeDefense;
            ArmorMagicalDefense = mate.ArmorInstance?.BaseMagicDefence ?? MagicalDefense;
