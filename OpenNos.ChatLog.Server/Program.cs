        ...
        public static void Main(string[] args)
        {
            try
            {
                ...
                try
                {
                    ...
                    server.AddService<IChatLogService, ChatLogService>(new ChatLogService());
                    if (ChatLogManager.Instance.AuthentificatedClients.Count != 0)
                    {
                        // Do nothing, just verify that ChatLogManager is initialized before anyone can connect
                    }
