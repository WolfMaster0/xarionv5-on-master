...
namespace OpenNos.Import.Console
{
    public class ImportFactory
    {
        ...
        private PartnerSpecialistType GetItemSpecialistType(short vnum)
        {
            switch (vnum)
            {
                case 4800:
                ...
                case 990:
                case 997:
                    return PartnerSpecialistType.Close;
                ...
                case 991:
                case 996:
                    return PartnerSpecialistType.Distance;
                ...
                case 992:
                case 995:
                    return PartnerSpecialistType.Magical;

                case 4326:
                    return PartnerSpecialistType.RagnarOnly;
            }

            return PartnerSpecialistType.None;
        }

        public void ImportPartnerSkills()
        {
            // Thank you entwell. Really.
            var list = new List<PartnerSkillsDTO>();

            //CLOSE
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4800, FirstSkill = 1235, SecondSkill = 1237, ThirdSkill = 1239, SpecialBuffId = 0, IdentifierKey = "AEGIR_SPECIALIST_CARD" }); // Aegir
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4804, FirstSkill = 1268, SecondSkill = 1269, ThirdSkill = 1273, SpecialBuffId = 0, IdentifierKey = "SHINOBI_SPECIALIST_CARD" }); // Shinobi
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4818, FirstSkill = 1292, SecondSkill = 1293, ThirdSkill = 1294, SpecialBuffId = 0, IdentifierKey = "FIONA_SPECIALIST_CARD" }); // Fiona
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4807, FirstSkill = 1292, SecondSkill = 1293, ThirdSkill = 1294, SpecialBuffId = 0, IdentifierKey = "FOXY_SPECIALIST_CARD" }); // Foxy
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4808, FirstSkill = 1299, SecondSkill = 1300, ThirdSkill = 1301, SpecialBuffId = 0, IdentifierKey = "MARU_MOM_SPECIALIST_CARD" }); // Maru
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4809, FirstSkill = 1299, SecondSkill = 1300, ThirdSkill = 1301, SpecialBuffId = 0, IdentifierKey = "MARU_SPECIALIST_CARD" }); // Maru maman
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4814, FirstSkill = 1358, SecondSkill = 1359, ThirdSkill = 1360, SpecialBuffId = 0, IdentifierKey = "AMON_SPECIALIST_CARD" }); // Amon
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4349, FirstSkill = 1358, SecondSkill = 1359, ThirdSkill = 1360, SpecialBuffId = 0, IdentifierKey = "DEMONAMON_SPECIALIST_CARD" }); // Archidemon Amon
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4815, FirstSkill = 1368, SecondSkill = 1369, ThirdSkill = 1370, SpecialBuffId = 0, IdentifierKey = "LUCIE_SPECIALIST_CARD" }); // Lucie
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4822, FirstSkill = 1439, SecondSkill = 1440, ThirdSkill = 1441, SpecialBuffId = 0, IdentifierKey = "MARION_SPECIALIST_CARD" }); // Marion
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4825, FirstSkill = 1449, SecondSkill = 1450, ThirdSkill = 1451, SpecialBuffId = 3000, IdentifierKey = "VENUS_SPECIALIST_CARD" }); // Venus
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4343, FirstSkill = 1521, SecondSkill = 1522, ThirdSkill = 1523, SpecialBuffId = 0, IdentifierKey = "FRANKENSTEIN_SPECIALIST_CARD" }); // Miaou fou

            //RANGE
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4802, FirstSkill = 1236, SecondSkill = 1238, ThirdSkill = 1240, SpecialBuffId = 0, IdentifierKey = "BARNI_SPECIALIST_CARD" }); // Barni
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4805, FirstSkill = 1270, SecondSkill = 1271, ThirdSkill = 1275, SpecialBuffId = 0, IdentifierKey = "LOTUS_SPECIALIST_CARD" }); // Lotus
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4812, FirstSkill = 1318, SecondSkill = 1319, ThirdSkill = 1320, SpecialBuffId = 0, IdentifierKey = "LUCIFER_SPECIALIST_CARD" }); // Lucifer
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4324, FirstSkill = 1318, SecondSkill = 1319, ThirdSkill = 1320, SpecialBuffId = 0, IdentifierKey = "GARDIANLUCIFER_SPECIALIST_CARD" }); // Lucifer Guardian
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4817, FirstSkill = 1371, SecondSkill = 1372, ThirdSkill = 1373, SpecialBuffId = 0, IdentifierKey = "CHLOE_SPECIALIST_CARD" }); // Chloé
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4325, FirstSkill = 1371, SecondSkill = 1372, ThirdSkill = 1373, SpecialBuffId = 0, IdentifierKey = "SHERIFFCHLOE_SPECIALIST_CARD" }); // Sheriff Chloé
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4821, FirstSkill = 1436, SecondSkill = 1437, ThirdSkill = 1438, SpecialBuffId = 0, IdentifierKey = "DANIELDUCAT_SPECIALIST_CARD" }); // Daniel Ducat
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4824, FirstSkill = 1446, SecondSkill = 1447, ThirdSkill = 1448, SpecialBuffId = 0, IdentifierKey = "NELYA_SPECIALIST_CARD" }); // Nelya
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4413, FirstSkill = 1628, SecondSkill = 1630, ThirdSkill = 1629, SpecialBuffId = 3021, IdentifierKey = "CUPIDIA_SPECIALIST_CARD" }); // Cupidia

            //MAGICAL
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4803, FirstSkill = 1241, SecondSkill = 1242, ThirdSkill = 1243, SpecialBuffId = 0, IdentifierKey = "FREYA_SPECIALIST_CARD" }); // Freya
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4806, FirstSkill = 1272, SecondSkill = 1274, ThirdSkill = 1276, SpecialBuffId = 0, IdentifierKey = "ORKANI_SPECIALIST_CARD" }); // Orkani
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4810, FirstSkill = 1315, SecondSkill = 1316, ThirdSkill = 1317, SpecialBuffId = 0, IdentifierKey = "HONGBI_SPECIALIST_CARD" }); // Hongbi
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4811, FirstSkill = 1315, SecondSkill = 1316, ThirdSkill = 1317, SpecialBuffId = 0, IdentifierKey = "CHEONGBI_SPECIALIST_CARD" }); // Cheongbi
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4813, FirstSkill = 1333, SecondSkill = 1334, ThirdSkill = 1335, SpecialBuffId = 0, IdentifierKey = "LAURENA_SPECIALIST_CARD" }); // Laurena
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4819, FirstSkill = 1379, SecondSkill = 1380, ThirdSkill = 1381, SpecialBuffId = 0, IdentifierKey = "DHINN_SPECIALIST_CARD" }); // Djinn
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4820, FirstSkill = 1433, SecondSkill = 1434, ThirdSkill = 1435, SpecialBuffId = 0, IdentifierKey = "ELIZA_SPECIALIST_CARD" }); // Eliza
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4823, FirstSkill = 1442, SecondSkill = 1443, ThirdSkill = 1444, SpecialBuffId = 0, IdentifierKey = "ARLEQUIN_SPECIALIST_CARD" }); // Arlequin
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4405, FirstSkill = 1602, SecondSkill = 1603, ThirdSkill = 1604, SpecialBuffId = 3014, IdentifierKey = "YUNA_SPECIALIST_CARD" }); // Yuna

            //RAGNAR ONLY
            list.Add(new PartnerSkillsDTO { PartnerVnum = 4326, FirstSkill = 1490, SecondSkill = 1491, ThirdSkill = 1492, SpecialBuffId = 3007, IdentifierKey = "SQUELETRAGNAR_SPECIALIST_CARD" }); // Ragnar Squelet

            DAOFactory.PartnerSkillsDAO.InsertOrUpdate(list);
            Logger.Info(string.Format(Language.Instance.GetMessageFromKey("PARTNER_SPECIALIST_PARSED")));
        }
        ...
        private PartnerSpecialistType GetMonsterType(int vnum)
        {
            switch (vnum)
            {
                case 318: // Tom
                ...
                while ((line = npcIdStream.ReadLine()) != null)
                {
                    ...
                    if (currentLine.Length > 2 && currentLine[1] == "VNUM")
                    {
                        npc = new NpcMonsterDTO
                        {
                            ...
                            SpecialistType = GetMonsterType(int.Parse(currentLine[2]))
                        };
                        itemAreaBegin = true;
                        unknownData = 0;
                    }
                    ...
                    else if (currentLine.Length > 7 && currentLine[1] == "ETC")
                    {
                        ...
                        if (npc.Name.EndsWith("Pod") || npc.Name.EndsWith("hive")
                            || npc.NpcMonsterVNum == 1906
                            || npc.NpcMonsterVNum == 1933
                            || npc.NpcMonsterVNum == 2013
                            || npc.NpcMonsterVNum == 2016)
                        {
                            npc.MonsterType = MonsterType.Summoner;
                        }
                    }
            ...
            using (StreamReader npcIdStream = new StreamReader(fileId, Encoding.GetEncoding(1252)))
            {
                ...
                while ((line = npcIdStream.ReadLine()) != null)
                {
                    ...
                    if (currentLine.Length > 3 && currentLine[1] == "VNUM")
                    {
                        ...
                        item.SpecialistType = GetItemSpecialistType(short.Parse(currentLine[2]));
                    }
