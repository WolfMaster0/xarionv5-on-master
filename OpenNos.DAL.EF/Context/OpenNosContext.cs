...
{
    [DbConfigurationType(typeof(OpenNosConfig))]
    public class OpenNosContext : DbContext
    {
        ...
        public virtual  DbSet<PartnerSkills> PartnerSkills { get; set; }
        ...
        public virtual DbSet<EventScript> EventScript { get; set; }
        ...
        {
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<OpenNosContext, Configuration>());
